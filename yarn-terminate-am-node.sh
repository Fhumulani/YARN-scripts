...
--steps '[{"Args":["spark-submit","--deploy-mode","cluster","--driver-memory","8G","s3://fhumustepvigi/chow-yarn-whole.py"],"Type":"CUSTOM_JAR","ActionOnFailure":"CONTINUE","Jar":"command-runner.jar","Properties":"","Name":"Reboot AM Node"}]' 
...
do
    ...
    then
      ...
      echo "sudo shutdown now" >> /home/hadoop/worker.sh
